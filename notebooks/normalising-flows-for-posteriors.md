...
description: >
  A flow turns a simple density into a complicated one through an invertible
  map. What that is worth in practice for posterior inference, and where it
  quietly fails.
date: 2026-08-17
tags: [inference, machine-learning, statistics]
source: notebook
draft: true
---
